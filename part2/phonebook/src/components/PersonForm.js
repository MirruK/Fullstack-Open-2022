    ...
    if (createdStatus !== 0) {
      ...
      addResponse
        .then((res) => {
          ...
          showMessage(
            `Successfully added person ${addedPerson.name} with id: ${addedPerson.id}`,
            3000,
            "green"
          );
          setNewPhoneNumber("");
        ...
        .catch((err) => {
          ...
          showMessage(err.response.data, 3000, "red");
          setNewPhoneNumber("");
          setNewName("");
          return;
        });
      ...
      requests
        ...
        .catch((err) =>
          showMessage(
            `Number update failed: Person already deleted. Msg. ${err.response.data}`,
            3000,
            "red"
          )
        );
